...
public final class PaginationUtil {
    ...
    public static Pager paginateList(List list, String reportName, String reportPeriod, Pageable pageable) {
        ...
        pagers.setStatus(200);
        pagers.setMessage("Success");
        pagers.setData(pages.getContent());
    ...
    public static Pager toPager(Page list, String reportName) {
        ...
        pagers.setStatus(0);
        pagers.setMessage("Success");
        pagers.setData(list.getContent());
        PageDetails details = new PageDetails();
    ...
    public static Pager toPager(List list,PageDetails pageDetails) {
        Pager pagers = new Pager();
        pagers.setStatus(200);
        pagers.setMessage("Success");
        pagers.setData(list);
        pagers.setPageDetails(pageDetails);
        return pagers;
    }
}
